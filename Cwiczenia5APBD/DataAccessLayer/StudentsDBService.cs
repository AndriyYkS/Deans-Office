...
namespace Cwiczenia5APBD.DataAccessLayer { 
    ...
    public class StudentsDBService
    {
       protected ObservableCollection<Student> studentsList;
        String connectionString = "Data Source=db-mssql;Initial Catalog=s15578;Integrated Security=True";
 ...
 /* 
insert into apbd.Student(FirstName,LastName,Address,IndexNumber,IdStudies) 
select zaw.imie,zaw.nazwisko,em.empno,miej.adres,1 from zawodnik zaw,emp em,MIEJSCEWYDARZENIA miej;
*/